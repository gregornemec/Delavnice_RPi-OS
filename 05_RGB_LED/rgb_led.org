...
*** Naloga: Stikalo s potisnim gumbom
    Stikalo pomeni, da ko gum pritisnemo se posamezna barva prižge. Ko ga
    pritisnemo drugič se led ugasne. 

    Logika delovanja programa bo naslednja, in bomo morali shranjevati vrednost
    za vklop ali izklop barve LED. Če barva LED ni prižgana jo moramo prižgati
    in si to zapomniti na primer z zapisom spremenljivke na vrednost 1. V
    kolikor je luč že prižgana jo ugasnemo in vrednost spremenimo na 0.
