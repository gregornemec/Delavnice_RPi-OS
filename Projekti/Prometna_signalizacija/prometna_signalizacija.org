...
* Vezje
  ...
  #+NAME:   fig:REB_sem
  [[file:breadboard/REB_RES_3LEDsem_2LED_sem_BT_BUZ_bb.png][breadboard/REB_RES_3LEDsem_2LED_sem_BT_BUZ_bb.png]]
...
*** Vezava LED 
    ...
    #+NAME:   fig:REB_sem
    [[file:breadboard/REB_1LED.png][breadboard/REB_1LED.png]]
...
*** Vezje
    ...
    #+NAME:   fig:REB_sem
    [[file:breadboard/REB_2LED_sem.png][/breadboard/REB_2LED_sem.png]]
...
*** Vezje
    #+CAPTION: Vezava 2x LED za semafor za peščce
    #+NAME:   fig:REB_sem
    [[file:breadboard/REB_3LED_sem.png][breadboard/REB_3LED_sem.png]]
